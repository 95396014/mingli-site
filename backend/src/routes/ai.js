...
### 三、大运流年分析
- **当前大运**：详细分析当前大运的吉凶、关键年份
- **近3年运势**：逐年分析2024/2025/2026年的运势特点和建议
- **关键转折点**：指出人生重要的转折年份和事件

### 四、具体建议
- **改运方法**：风水、方位、颜色、行业等具体建议
- **注意事项**：需要规避的风险和时间点
...
4. 使用 Markdown 格式，层级清晰，总字数 **1200-2000字**
5. 每个分析点要具体、可操作，避免空泛描述`,
